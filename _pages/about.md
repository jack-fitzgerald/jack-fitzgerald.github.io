...
Equivalence testing is a major focus of my current research. I have documented [empirical evidence](https://jack-fitzgerald.github.io/files/The_Need_for_Equivalence_Testing_in_Economics.pdf)" that null claims made in the absence of equivalence testing exhibit high error rates in economics, offering practical guidelines and developing [software commands](https://jack-fitzgerald.github.io/code/) for implementing such testing. I also introduce equivalence testing methods to different disciplines through empirical applications (for example, see [my article in <i>Journal of Business Ethics</i>](https://doi.org/10.1007/s10551-024-05731-x)). 
